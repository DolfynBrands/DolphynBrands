...
export default function ContactSection() {
  ...
  return (
    <section id="partner-up" className="py-20 bg-gradient-to-br from-white to-gray-50">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            <h2 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6">
              Partner <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">With Us</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div variants={itemVariants}>
              <div className="bg-white backdrop-blur-sm border border-gray-200 rounded-3xl p-8 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 px-6 rounded-xl font-semibold flex items-center justify-center space-x-2 hover:shadow-lg transition-shadow"
                  >
                    <Send size={20} />
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              {/* WhatsApp */}
              <div className="bg-gradient-to-r from-green-500 to-green-400 rounded-3xl p-8 text-white shadow-lg">
